...
func NewCheckEngine(e *environment.Environment) (error, *CheckEngine){
  ...
  cks.subscriptions = make(map[chan interface{}] string)
...
func (c *CheckEngine) SetSubscriptions(o map[chan interface{}] string) {
...
func (c *CheckEngine) GetSubscriptions() map[chan interface{}] string {
...
//
//# AddOutputSampleChan:
func (c *CheckEngine) Subscribe(o chan interface{}, desc string) error {
...
func (c *CheckEngine) notify(s *sample.CheckSample) {
  ...
  for c,desc := range c.GetSubscriptions(){
