...
func NewEnvironment() (error, *Environment) {
	...
	if err, context = newCurrentContext(output); err != nil {
		return err, nil
	}
	if err, setup = newSetupObject(context.SetupFile, context.ConfigFolder, output); err != nil {
		return err, nil
	}
...
func (e *Environment) validateEnvironment() error {
	...
	s := e.GetSetup()
	if err := s.validateSetupObject(); err == nil {
		return err
	}
...
//
// GetNodeInfo return info from node
func (e *Environment) GetNodeInfo() ([]byte, error) {
...
func (e *Environment) GetCluster() ([]byte, error) {
...
func (e *Environment) String() string {
	...
	str, err = utils.ObjectToJSONString(e)
	if err != nil {
		return err.Error()
	}
