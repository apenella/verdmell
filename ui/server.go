...
func NewUI(e *environment.Environment, listenaddr string) *UI {
	...
	jsClusterlistitemdetails := path.Join("ui","scripts", "clusterlistitemdetails.js")
	...
	if ui == nil {
		...
		ui.SetTemplates(template.Must(template.ParseFiles(index,jsLibJQquery,jsLibUnderscore,jsUtils,jsMenu,jsClusterlist,jsClusterlistitemdetails,jsChecks,jsVerdmell,style,header,content,footer)))
