...
func (a* ApiEngine) GenerateAPIRoutesForSamples() {
	...
	a.AddRoute(ui.GenerateRoute("allservices","GET","/api/samples",apiWriter(GetAllSamples)))
	a.AddRoute(ui.GenerateRoute("service","GET","/api/samples/{sample}",apiWriter(GetSample)))
}
