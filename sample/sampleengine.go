...
func (eng *SampleEngine) GetSampleForCheck(name string) ([]byte, error) {
	env.Output.WriteChDebug("(SampleEngine::GetSampleForCheck)")
	var sample *CheckSample
	var err error

	err, sample = eng.GetSample(name)
	if err != nil {
...
func (eng *SampleEngine) String() string {
	var str string
	var err error
...
//
// Itoa method transforms an integer to status string
